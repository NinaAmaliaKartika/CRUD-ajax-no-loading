            ...
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <div class="input" style="margin-top: 3%">
                        <input type="radio" name="jklmn" id="jklmn1" value="Laki-laki" required="true">Laki-laki
                        <input type="radio" name="jklmn" id="jklmn2" value="Perempuan" required="true" style="margin-left: 10px;">Perempuan
                    </div>
                </div>
                <p class="text-danger" id="err_jklmn"></p>
            </div>
        </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#simpan").click(function() {
                ...
                var jklmn1 = document.getElementById("jklmn1").value;
                var jklmn2 = document.getElementById("jklmn2").value;
                ...
                if (document.getElementById("jklmn1").checked == false &&
                    document.getElementById("jklmn2").checked == false) {
                    document.getElementById("err_jklmn").innerHTML = "Jenis Kelamin Harus Dipilih";
                } else {
                    document.getElementById("err_jklmn").innerHTML = "";
                }
